    ...
    >
      <tr>
        <td valign="top" style="width:40%;">
          ...
          >
            <img
              src="https://static.cdn.responsys.net/i5/responsysimages/content/alaskaair/ALA_EZ_Header_370x220.jpg"
              width="185"
              border="0"
              alt="Alaska® EasyBiz"
                ...
                >
                  <tr>
                    ...
                    >
                      ...
                      , Not a Mileage Plan&trade;&nbsp;Member? &nbsp;<a
          ...
          <#if MEMBER_INFO.MEMBER_NUM gte 0 && (MEMBER_INFO.LOYALTY_STATUS ='Active')>
            ...
            <tr>
                <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif; font-size:14px;line-height:20px;color:#ffffff;text-align:right;">
                    <em><#if FIRST_NAME?has_content>\${FIRST_NAME?capitalize} \${LAST_NAME?capitalize}</#if></em> &nbsp;
            ...
            <tr>
                <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif; font-size:14px;line-height:20px;color:#ffffff;text-align:right;">
                    ...
                    <#if CURRENT_TIER?has_content>\${CURRENT_TIER}<#elseif CURRENT_TIER == 'Regular'>Mileage Plan Member</#if>
                </td>
            </tr>
            </table>
        <#else>
            ...
            <tr>
                <td style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif; font-size:14px;line-height:20px;color:#ffffff;text-align:right;">
                    <span style="font-style:italic;">\${FIRST_NAME?capitalize}</span>, Not a Mileage Plan&trade;&nbsp;Member? &nbsp;<a href="\${clickthrough('PreHeader_SignUp', 'linkname=PreHeader_SignUp')}" style="font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:14px;color:#ffffff;text-decoration:underline;">Sign up today</a>
                </td>
            </tr>
            </table>
        </#if>
